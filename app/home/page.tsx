...
//             <div className="inline-block bg-yellow-400 text-blue-900 px-6 py-2 rounded-full text-sm font-semibold mb-6">
//               🎓 Est. 1980 • Legacy of Excellence
//             </div>
//           </motion.div>
...
//                 <motion.div 
//                   key={index}
//                   className={`bg-gray-50 rounded-xl p-6 border-l-4 border-${item.color}-600 hover:shadow-lg transition-all duration-300`}
//                   initial={{ opacity: 0, x: 30 }}
//                   whileInView={{ opacity: 1, x: 0 }}
//                   viewport={{ once: true }}
...
//                   <div className={`absolute inset-0 bg-${program.color}-900/20`}></div>
//                   <motion.div 
//                     className={`absolute top-4 left-4 bg-${program.color}-500 text-white px-4 py-2 rounded-full font-bold`}
...
//                       >
//                         <motion.span 
//                           className={`w-2 h-2 bg-${program.color}-600 rounded-full mr-2`}
//                           animate={{ scale: [1, 1.5, 1] }}
